  ...
  **/
  ...
  interpret(response) {
    ...
    return {
      ...
      'TRUMP': `The most advanced AI technology has detected that it is impossible for YOU to be a child of Elon Müsk. But don't get ${negation} too quickly—the AI has identified, with ${response.confidence} confidence, that you are most likely biologically related to Donald Trümp.`,
    }[response.prediction];
  }
}
